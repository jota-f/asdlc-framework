...
0. **HOT START & CHECKPOINT (MANDATÓRIO)**: Antes de ler a story, o agente DEVE verificar se existe o arquivo `.asdlc/context_checkpoint.md` na raiz do projeto.
    - **Se existir**: Leia o arquivo, aplique seu resumo na memória de trabalho ativa e **exclua** ou **renomeie** o arquivo (ex: para `.asdlc/context_checkpoint.consumed`) usando as ferramentas do sistema de arquivos para evitar injeções repetidas.
