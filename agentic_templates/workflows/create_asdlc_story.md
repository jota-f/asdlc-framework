...
2. **INJEÇÃO DE CONTEXTO (OBRIGATÓRIO)**: O agente DEVE tentar ler o `PROJECT_CONTEXT.md`, `GLOSSARY.md`, o índice de decisões `docs/adr/LEARNING.md` (se este índice não existir, consulte `docs/adr/`) e o **`BACKLOG.md`**.
