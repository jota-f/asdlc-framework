...
0. **INJEÇÃO DE CONTEXTO (OBRIGATÓRIO)**: O agente DEVE tentar ler o `GLOSSARY.md`, o índice de decisões de arquitetura **`docs/adr/LEARNING.md`** (se não existir este índice, consulte `docs/adr/`) e o **`BACKLOG.md`**.
