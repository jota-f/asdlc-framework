# 📜 PROJECT_CONTEXT.md - web_api

## 1. Visão Geral do Projeto

**Nome do Projeto**: web_api

**Objetivo do Projeto**: Task Manager API - Sistema de gestão de tarefas usando FastAPI. Endpoints para CRUD de tarefas, autenticação JWT, validação de dados com Pydantic. Features: criar, ler, atualizar, deletar tarefas. Integração com banco SQLite. Documentação automática com Swagger.

**Tipo de Aplicação**: web_api
