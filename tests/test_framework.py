...
class TestProjectManager:
    ...
    def test_create_project_structure(self):
        ...
        with patch("asdlc.project_manager.PlanGenerator") as mock_plan_gen:
            ...
            result = self.project_manager.create_project_structure(project_name, project_type, self.temp_dir)
...
class TestStoryManager:
    ...
    def test_create_story(self):
        ...
        with patch("asdlc.story_manager.PlanGenerator") as mock_plan_gen:
            ...
            result = self.story_manager.create_story(story_title, story_description, project_type, self.temp_dir)
...
class TestPlanGenerator:
    ...
    def test_generate_project_context(self):
        ...
        with patch("asdlc.plan_generator.LLMClient") as mock_llm:
            ...
            result = self.plan_generator.generate_project_context(project_name, project_type, prompt)
    ...
    def test_generate_plan(self):
        ...
        with patch("asdlc.plan_generator.LLMClient") as mock_llm:
            ...
            result = self.plan_generator.generate_plan(story_title, story_description, project_type)
...
class TestFrameworkIntegration:
    ...
    def test_full_workflow(self):
        ...
        with patch("asdlc.plan_generator.LLMClient") as mock_llm:
            ...
            result = project_manager.create_project_structure("test-project", "cli", self.temp_dir)
            assert result is True

            # Criar story
            story_manager = StoryManager()
            result = story_manager.create_story(
                "Test Story", "Uma story de teste", "cli", os.path.join(self.temp_dir, "test-project")
            )
            assert result is True
